...
##
## S A L P E T E R    T I M E S C A L E S
...
xmax =  1.4 
## REDSHIFT RANGE
zmin =  5.8     ## 5.8 ## 3.0    ## 4.3
zmax =  48.0    ## 16.0 ## z=45 in Banados 2018
##  Mass access
ymin =  0.1    #  6.5   2.8 good if redshift is z= 45. 
ymax = 10.5    # 10.5
...
##   L E G E N D
ax1.legend(loc='upper right', fontsize=fontsize/1.3, frameon='True', framealpha=.85)
